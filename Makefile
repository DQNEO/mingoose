...
$(PROG): src/mingoose.c src/mingoose.h src/request.c src/string.c src/parse_date.c src/mg_printf.c src/response.c
	$(CC) src/mingoose.c src/request.c src/string.c src/options.c src/parse_date.c src/auth.c src/mg_printf.c src/response.c -o $@ $(CFLAGS)
